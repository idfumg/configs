...
----------------------------------------------------------------------------------------
-- Volume
volume_master = blingbling.volume({ height = 15,
									width = 50,
									bar = true,
									show_text = false,
									font = "Droid Sans",
...
netwidget = blingbling.net({interface = "wlp7s0",
							show_text = true,
							font = "Droid Sans",
							font_size = "12",
							text_color = "#C1C0DE",
...
vicious.register(netdown_graph, vicious.widgets.net, "${wlp7s0 down_kb}")
...
vicious.register(netup_graph, vicious.widgets.net, "${wlp7s0 up_kb}")
